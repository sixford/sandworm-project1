...
To play the game locally or access the code, follow these steps:

Clone the repository:


git clone https://github.com/sixford/sandworm-project1.git
Navigate to the project directory:

cd dune-sandworm
Open the game in your browser: 

Simply open the index.html file in your preferred browser to start playing the game.
